...
const Home = () => {
  return (
    <>
      <Seo
        title={`${company.name} | Medical and Laboratory Equipment in Qatar`}
        description="Trusted supplier of medical, laboratory, serology, microbiology, food testing, and veterinary equipment in Qatar."
        path="/"
      />
        ...
        <div className="relative container mx-auto container-px py-24 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 reveal">
            ...
            <h1 className="font-display font-bold text-primary-foreground text-4xl sm:text-5xl lg:text-6xl xl:text-7xl leading-[1.05]">
              Precision Equipment for <span className="text-accent">Modern Healthcare</span>
            </h1>
            <p className="mt-6 text-lg lg:text-xl text-primary-foreground/85 max-w-2xl leading-relaxed">
              Extreme Medical Solution supplies hospitals, research institutes, and diagnostic laboratories across Qatar
              with reliable medical and laboratory equipment from internationally trusted manufacturers.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3 text-sm text-primary-foreground/75">
              {["ISO-aligned suppliers", "In-country support", "Fast delivery"].map((item) => (
      ...
      <section className="py-24">
        <div className="container mx-auto container-px grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-block text-xs font-semibold tracking-[0.2em] uppercase text-accent mb-4">About us</div>
            ...
            <p className="mt-6 text-muted-foreground text-lg leading-relaxed">
              Since 2015, Extreme Medical Solution has been a trusted partner for healthcare facilities, research
              institutions, and diagnostic laboratories, delivering products that meet international standards for
      ...
      <section className="py-24 bg-gradient-soft">
        <div className="container mx-auto container-px">
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-primary leading-tight">
              Products and services for every laboratory.
            </h2>
            <p className="mt-5 text-muted-foreground text-lg">
              From benchtop instruments to daily-use consumables, we source from internationally certified
              manufacturers and support customers locally in Qatar.
            </p>
          </div>
        ...
        <div className="container mx-auto container-px">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-1">
              ...
              <h2 className="font-display text-4xl font-bold text-primary leading-tight">Beyond supply, we partner with you.</h2>
              <p className="mt-5 text-muted-foreground">
                We do more than deliver equipment. We help plan, install, train, and maintain so your team can focus on
                what matters.
              </p>
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-5">
              {services.slice(0, 4).map((service, index) => (
                <div key={service.title} className="group rounded-xl border bg-card p-6 hover:border-accent/50 hover:shadow-soft transition-all">
                  <div className="text-xs font-mono text-accent mb-3">0{index + 1}</div>
                  <h3 className="font-display font-semibold text-lg text-primary mb-2">{service.title}</h3>
            ...
            <div className="relative grid lg:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <p className="mt-4 text-primary-foreground/80 text-lg">
                  Tell us what your lab needs and we&apos;ll respond within one business day.
                </p>
              </div>
